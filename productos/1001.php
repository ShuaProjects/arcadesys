...
<html lang="en">
    <head>
        ...
        <title>Doble carhador de cotrol PS</title>
    </head>
    ...
    <body>
        ...
        <div class="container" id="contenejuegos" style="margin-top: 200px; margin-bottom: 200px;">
            <div class="row">
                <div class="col">
                    <img src="../img/catalogs/accesorios/caga2contrl.jpg" alt="Spider-Man">
                </div>
                
                <div class="col" >
                    <h4>
                        Doble carhador de cotrol PS
                    </h4>
                    <br>
                    <h5>
                        Consola: 
